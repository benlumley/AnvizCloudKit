...
//        $pack .= str_pad($idd, 16, '0', STR_PAD_LEFT);
    ...
    {
        return Tools::R(self::joinCommand('11111111', $device_id, '11111111', AnvizConstants::CMD_REGESTER, 15, ''));
    }

    public static function showError($sha1, $device_uuid, $command = '')
    {
        return Tools::R(self::joinCommand($sha1, $device_uuid, '11111111', AnvizConstants::CMD_ERROR, 15, $command));
    }

    public static function showForbidden()
    {
        return Tools::R(self::joinCommand('11111111', '22222222', '22222222', AnvizConstants::CMD_FORBIDDEN, 15, ''));
    }

    public static function showNocommand($token, $device_id)
    {
        return Protocol::joinCommand($token, $device_id, '11111111', AnvizConstants::CMD_NOCOMMAND, 15);
    }
