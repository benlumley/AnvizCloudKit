...
class Montitor
{
    ...
    public function actionRegister($data = "")
    {
        ...
        $command = Protocol::joinCommand($token, $id, '11111111', AnvizConstants::CMD_LOGIN, 15, $id);
    ...
    public function actionTransport($serial_number = "", $data = "")
    {
        ...
        if (empty($data)) {
            ...
            $command = Protocol::joinCommand($token, $device_id, $data['id'], $data['command'], 15, $data['content']);
        }
